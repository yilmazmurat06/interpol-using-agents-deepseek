---
description: Dockerizes the system and writes operational documentation. Produces Dockerfiles, docker-compose, env config, and README.
...
## Output contract
- Every file written at the exact path from CLAUDE.md → File Layout, relative to the repo root.
